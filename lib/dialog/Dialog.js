...
var stdin_default = (0, import_vue2.defineComponent)({
  ...
  setup(props, {
    ...
    const validateInput = () => {
      ...
      inputError.value = !!inputPattern && !new RegExp(inputPattern).test(inputValue.value);
    };
    const onInput = (event) => {
    ...
    const getActionHandler = (action) => () => {
      ...
      if (action === "confirm" && props.inputPattern) {
        validateInput();
        if (inputError.value)
          return;
      }
    ...
    const renderMessage = (hasTitle) => {
      ...
      return (0, import_vue.createVNode)("div", {
        "class": classNames
      }, [content, inputPattern ? (0, import_vue.createVNode)("input", {
        "class": bem("input"),
